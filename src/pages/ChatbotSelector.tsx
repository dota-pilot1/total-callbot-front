        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 bg-muted/60 rounded-full flex items-center justify-center border border-border">
                <span className="text-foreground font-bold text-sm">콜</span>
              </div>
              <h1 className="text-xl font-semibold text-foreground">개발 교육 챗봇</h1>
            </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 min-w-0">
          <main className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              <div className="rounded-lg shadow-sm border border-border bg-card p-6">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-foreground">개발봇 (11개)</h3>
                </div>
              ...
              <div className="rounded-lg shadow-sm border border-border bg-card p-6">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-foreground">교육봇 (3개)</h3>
                </div>
                <p className="text-muted-foreground text-sm">
              ...
              <div className="rounded-lg shadow-sm border border-border bg-card p-6">
                <div className="flex items-center space-x-3 mb-3">
                  ...
                  <h3 className="text-lg font-semibold text-foreground">문서관리+유틸봇 (4개)</h3>
                </div>
                <p className="text-muted-foreground text-sm">
            ...
            {/* 사용 안내 */}
            <div className="rounded-lg shadow-sm border border-border bg-card p-8">
              <h3 className="text-xl font-semibold text-foreground mb-4 text-center">
                💡 사이드바 사용법
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-medium text-foreground mb-2">🎯 초보자 추천 순서</h4>
                ...
                <div>
                  <h4 className="font-medium text-foreground mb-2">🚀 취업 준비자 추천</h4>
                  <div className="space-y-1 text-sm text-muted-foreground">
