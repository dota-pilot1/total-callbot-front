...
export default function ScenarioManagement() {
  ...
  const categoryGroups = scenarios.reduce<
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        >
          <PlusIcon className="h-4 w-4" />새 시나리오 추가
        </Button>
      </div>
                      ...
                      >
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-4 mt-2 text-xs text-muted-foreground">
                            ...
                            <span>
                              역할: {scenario.userRole} ↔ {scenario.aiRole}
                            </span>
                          </div>
                        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    handleInputChange("aiKnowledge", e.target.value)
                  }
                  className="w-full p-2 border border-border rounded-md bg-background h-20"
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="rounded"
                />
                <label htmlFor="aiStarts" className="text-sm">
                  AI가 먼저 대화를 시작
                </label>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleInputChange("conversationStyle", e.target.value)
                    }
                    className="w-full p-2 border border-border rounded-md bg-background"
                  >
