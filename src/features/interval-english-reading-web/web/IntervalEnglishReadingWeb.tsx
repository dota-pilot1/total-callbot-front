...
const IntervalEnglishReadingWeb: React.FC = () => {
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              단계별 속도 조절로 영어 독해 실력을 향상시켜보세요
            </p>
          </div>
          <Button
            onClick={() => navigate("/interval-english-reading-web/create")}
          ...
          <Card>
            <CardContent className="text-center py-12">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <Button
                  onClick={() =>
                    navigate("/interval-english-reading-web/create")
                  }
                >
                  첫 번째 테스트 만들기
                </Button>
...
export default IntervalEnglishReadingWeb;
