...
interface MobileExamSettingsDropdownProps {
  isOpen: boolean;
  onClose: () => void;
  // 음성 설정
  speechLang: "ko" | "en";
...
export default function MobileExamSettingsDropdown({
  isOpen,
  onClose,
  speechLang,
  onSpeechLangChange,
  ...
  onClearChat,
}: MobileExamSettingsDropdownProps) {
  // 토글 스위치 컴포넌트
  const ToggleSwitch = ({
    enabled,
    onChange,
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            {/* 헤더 */}
            <div className="sticky top-0 bg-gradient-to-r from-purple-600 to-blue-600 text-white border-b border-purple-300 px-4 py-3 flex justify-between items-center">
              <div className="flex items-center space-x-2">
                <AcademicCapIcon className="h-5 w-5" />
                <h2 className="text-lg font-semibold">시험 설정</h2>
              </div>
              <button
                onClick={onClose}
              ...
              <div>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">배경 소음 제거 기능</p>
                  </div>
                  <ToggleSwitch
