...
export default function DailyEnglish() {
  ...
  const handleStartScenario = (scenario: ScenarioItem) => {
    ...
    navigate('/daily-english-exam', { state: { scenario } });
  };
      ...
      <div className="container mx-auto px-4 py-6 max-w-5xl">
        ...
        {selectedMode === 'basic' && (
          <div className="mt-8 space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-foreground">베이직 회화 연습</h2>
              <Button variant="outline" size="sm" onClick={() => setIsBasicDialogOpen(true)}>
                상황 다시 선택하기
              </Button>
            </div>
              ...
              <Card>
                <CardContent className="py-10 text-center space-y-4">
                  <p className="text-sm text-muted-foreground">
                    위의 베이직 카드에서 상황 선택을 눌러 주제를 생성하면 연습 카드가 보여집니다.
                  </p>
                  <Button onClick={() => setIsBasicDialogOpen(true)}>상황 선택하기</Button>
                </CardContent>
              </Card>
            )}
          </div>
        ...
        {selectedMode === 'youtube' && (
          <Card className="mt-8">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                유튜브 영상과 함께하는 리스닝·쉐도잉 연습을 준비 중입니다. 곧 다양한 콘텐츠로 찾아올게요!
              </p>
            </CardContent>
          </Card>
        )}
        ...
        {selectedMode === 'news' && (
          <Card className="mt-8">
            ...
            <CardContent>
              <p className="text-sm text-muted-foreground">
                최신 뉴스 기사로 독해와 리스닝을 동시에 연습할 수 있는 모듈을 개발 중입니다.
              </p>
            </CardContent>
          </Card>
        )}
      ...
      >
        <div className="h-full overflow-y-auto bg-background">
          <div className="px-4 py-6 sm:px-6">
            <p className="text-sm text-muted-foreground">
              연습하고 싶은 상황을 선택하면 해당 주제에 맞는 기본 회화 문제가 제공됩니다.
            </p>
                    ...
                    return (
                      <Button
                        ...
                        className={`whitespace-nowrap ${
                          isActiveCategory ? 'shadow-md ring-2 ring-blue-200' : ''
                        }`}
                      >
