...
export async function translateToEnglish(
  ...
  if (!koreanText.trim()) return null;
          ...
          messages: [
            {
              role: "system",
              content:
                "You are a professional translator. Translate the following Korean text to natural English. Provide only the translation result.",
            },
            {
              role: "user",
              content: koreanText,
