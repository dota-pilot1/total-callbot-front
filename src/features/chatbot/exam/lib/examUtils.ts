...
export const buildSingleExamPrompt = (topic: ExamTopic): string => {
  const header = [
    ...
    "",
    "**역할극 진행 방식:**",
    "1. 자연스럽게 대화 시작 (레벨 선택 없음)",
    "2. 사용자 응답에 자연스럽게 반응",
    "3. 평가 요청이 있을 때만 평가 제공",
    "",
  ];
  ...
  const format = [
    "대화 형식:",
    "- **자연스러운 역할극 대화 진행**",
    "- **시작**: 상황에 맞는 인사와 질문으로 시작",
    "- **진행**: 사용자 응답에 자연스럽게 반응하며 대화 지속",
    "",
    "- 질문은 명확성을 위해 이중언어 사용 가능:",
    "  예:",
    "  Tell me about yourself.",
    "  [KO] 자기소개를 해주세요.",
    "",
    "- 시험 번호나 형식적인 접두어 사용하지 말 것",
    "- 난이도 질문 생략하고 자연스럽게 중급 수준으로 진행",
    "- **중요**: 자동으로 평가하지 말고 자연스럽게 대화 지속",
    "- **평가**: 사용자가 명시적으로 요청할 때만 제공",
    "",
  ];
